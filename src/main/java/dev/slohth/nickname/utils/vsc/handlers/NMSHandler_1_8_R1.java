...
public class NMSHandler_1_8_R1 implements NMSHandler {
    ...
    public void applyNickname(User user, Nick nick) {
        ...
        // TODO: luckperms group edit

        boolean fly = user.getPlayer().getAllowFlight();

        connection.sendPacket(new PacketPlayOutPlayerInfo(EnumPlayerInfoAction.REMOVE_PLAYER, player.getHandle()));
        connection.sendPacket(new PacketPlayOutPlayerInfo(EnumPlayerInfoAction.ADD_PLAYER, player.getHandle()));
