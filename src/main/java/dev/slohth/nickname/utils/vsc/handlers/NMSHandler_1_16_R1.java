...
public class NMSHandler_1_16_R1 implements NMSHandler {
    ...
    public void applyNickname(User user, Nick nick) {
        ...
        PacketPlayOutRespawn respawn = new PacketPlayOutRespawn(worldserver.getTypeKey(), worldserver.getDimensionKey(), BiomeManager.a(worldserver.getSeed()), ep.playerInteractManager.getGameMode(), ep.playerInteractManager.c(), worldserver.isDebugWorld(), worldserver.isFlatWorld(), true);
    ...
    public GameProfile getProfile(Player player) {
        return ((org.bukkit.craftbukkit.v1_16_R1.entity.CraftPlayer) player).getProfile();
    }
