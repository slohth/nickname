...
public class NMSHandler_1_13_R2 implements NMSHandler {
    ...
    public void applyNickname(User user, Nick nick) {
        ...
        PacketPlayOutRespawn respawn = new PacketPlayOutRespawn(worldserver.worldProvider.getDimensionManager(), worldserver.getDifficulty(), worldserver.getWorldData().getType(), ep.playerInteractManager.getGameMode());
    ...
    public GameProfile getProfile(Player player) {
        return ((org.bukkit.craftbukkit.v1_13_R2.entity.CraftPlayer) player).getProfile();
    }
