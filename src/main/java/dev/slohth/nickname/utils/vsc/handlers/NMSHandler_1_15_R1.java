...
public class NMSHandler_1_15_R1 implements NMSHandler {
    ...
    public void applyPackets(User user) {
        ...
        PacketPlayOutRespawn respawn = new PacketPlayOutRespawn(worldserver.worldProvider.getDimensionManager(), WorldData.c(worldserver.getWorldData().getSeed()), worldserver.getWorldData().getType(), ep.playerInteractManager.getGameMode());
    ...
    public GameProfile getProfile(Player player) {
        return ((org.bukkit.craftbukkit.v1_15_R1.entity.CraftPlayer) player).getProfile();
    }
